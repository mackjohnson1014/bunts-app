...
export const RELEASES: Release[] = [
  {
    ...
    notes: [
      ...
      'New: each player now shows a second row with their stats for the current week, colored green or red against their own season pace (or a neutral dot when it\u2019s right on pace) \u2014 a hot or cold stretch jumps out without opening their card.',
