...
export const mockRoster: Roster = {
  ...
  players: [
    ...
    },
    {
      ...
      positions: ['SP'], slot: 'P', status: null,
      startingToday: false, opponent: null, opposingPitcher: null,
    ...
    },
    {
      ...
      positions: ['OF', 'UTIL'], slot: 'UTIL', status: null,
    ...
    },
    {
      ...
      positions: ['RP'], slot: 'P', status: null,
    ...
    {
      playerKey: 'p.24', name: 'Marco Villalobos', mlbTeam: 'CIN',
      positions: ['SP'], slot: 'P', status: null,
      startingToday: true, opponent: '@ PIT', opposingPitcher: null,
      seasonStats: { G: 27, W: 10, SV: 0, K: 163, ERA: 3.55, WHIP: 1.18 },
      last14Stats: { G: 3, W: 1, SV: 0, K: 19, ERA: 2.95, WHIP: 1.05 },
      percentOwned: 73,
      recentGames: [
        { date: '2026-09-12', opponent: '@ PIT', summary: '6.0 IP, 2 ER, 7 K', quality: 'good' },
        { date: '2026-09-07', opponent: 'vs MIL', summary: '5.2 IP, 3 ER, 6 K', quality: 'neutral' },
        { date: '2026-09-02', opponent: '@ CHC', summary: '7.0 IP, 1 ER, 6 K', quality: 'good' },
        { date: '2026-08-28', opponent: 'vs STL', summary: '4.2 IP, 5 ER, 4 K', quality: 'bad' },
        { date: '2026-08-23', opponent: '@ ARI', summary: '6.0 IP, 2 ER, 8 K', quality: 'good' },
      ],
      note: null,
    },
    {
      playerKey: 'p.25', name: 'Theo Brannigan', mlbTeam: 'CLE',
      positions: ['OF'], slot: 'BN', status: null,
      startingToday: true, opponent: '@ DET', opposingPitcher: 'J. Pace',
      seasonStats: { G: 97, R: 41, HR: 12, RBI: 45, SB: 4, AVG: 0.247 },
      last14Stats: { G: 10, R: 4, HR: 1, RBI: 6, SB: 1, AVG: 0.263 },
      percentOwned: 15,
      recentGames: [
        { date: '2026-09-12', opponent: '@ DET', summary: '1-4, RBI', quality: 'neutral' },
        { date: '2026-09-11', opponent: '@ DET', summary: '2-4, HR, 2 RBI', quality: 'good' },
        { date: '2026-09-10', opponent: 'vs MIN', summary: '0-3', quality: 'bad' },
        { date: '2026-09-09', opponent: 'vs MIN', summary: '1-4', quality: 'neutral' },
        { date: '2026-09-08', opponent: '@ KC', summary: '1-3, 2B', quality: 'neutral' },
      ],
      note: null,
    },
    {
      playerKey: 'p.26', name: 'Dane Kirilenko', mlbTeam: 'ATL',
      positions: ['RP'], slot: 'BN', status: null,
      startingToday: null, opponent: 'vs MIA', opposingPitcher: null,
      seasonStats: { G: 64, W: 5, SV: 3, K: 88, ERA: 2.74, WHIP: 1.07 },
      last14Stats: { G: 6, W: 1, SV: 1, K: 9, ERA: 1.80, WHIP: 0.90 },
      percentOwned: 31,
      recentGames: [
        { date: '2026-09-12', opponent: 'vs MIA', summary: '1.0 IP, 2 K', quality: 'good' },
        { date: '2026-09-11', opponent: 'vs MIA', summary: 'Did not pitch', quality: 'dnp' },
        { date: '2026-09-10', opponent: '@ NYM', summary: '1.1 IP, 0 ER', quality: 'good' },
        { date: '2026-09-09', opponent: '@ NYM', summary: '1.0 IP, 1 ER', quality: 'neutral' },
        { date: '2026-09-08', opponent: 'vs PHI', summary: '1.0 IP, SV, 1 K', quality: 'good' },
      ],
      note: null,
    },
    {
      playerKey: 'p.27', name: 'Emilio Vasquez', mlbTeam: 'HOU',
      positions: ['OF', 'UTIL'], slot: 'IL', status: 'IL10',
      startingToday: false, opponent: null, opposingPitcher: null,
      seasonStats: { G: 76, R: 38, HR: 15, RBI: 49, SB: 6, AVG: 0.268 },
      last14Stats: { G: 0 },
      percentOwned: 58,
      recentGames: [],
      note: 'Oblique strain, out since late August. Eligible to return this month.',
    },
  ],
};
